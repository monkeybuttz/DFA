...
public class NFA2DFA {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ReturnStructure<Hashtable<Pair<Character, Character>, ArrayList<Integer>>, String, String[], String[], ArrayList<String>>  returnStruct = Parse.ParseStudentA(NFA);
    ...
    public static void convertNFA2DFA(ReturnStructure<Hashtable<Pair<Character, Character>, ArrayList<Integer>>, String, String[], ArrayList<String>>  returnStruct) {
